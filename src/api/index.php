            ...
            <div class="col-md-12">
                ...
                if($result = sqlsrv_query($conn, $sql , $params, $options)){
                    if(sqlsrv_num_rows($result) > 0){
                        ...
                        echo "<th>Name</th>";
                        echo "<th>Password</th>";
                        echo "<th>CompanyDB</th>";
                        echo "<th>LicenseLevel</th>";
                        echo "<th>Firm</th>";
                        echo "<th>BranchName</th>";
                        // echo "<th>LoginTime</th>";
                        echo "<th>Status</th>";
                        echo "<th>BillingMonth</th>";
                        echo "<th>Network</th>";
                        echo "</tr>";
                        echo "</thead>";
                        echo "<tbody>";
                        while($row = sqlsrv_fetch_array($result)){
                            echo "<tr>";
                            echo "<td>" . $row['UserAutonumber'] . "</td>";
                            echo "<td>" . $row['UserName'] . "</td>";
                            echo "<td>" . $row['Password'] . "</td>";
                            echo "<td>" . $row['CompanyDB'] . "</td>";
                            echo "<td>" . $row['LicenseLevel'] . "</td>";
                            echo "<td>" . $row['Firm'] . "</td>";
                            echo "<td>" . $row['BranchName'] . "</td>";
                            // echo "<td>" . $row['LoginTime'] . "</td>";
                            echo "<td>" . $row['Status'] . "</td>";
                            echo "<td>" . $row['BillingMonth'] . "</td>";
